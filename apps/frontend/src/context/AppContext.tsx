...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    // Load data on mount — this breaks the circular dependency where
    // ProtectedRoute waits for dataLoaded but AdminLayout (which calls loadData) is inside ProtectedRoute
    ...
    // Auto-load data when the app mounts
